    ...
    <>
      <Navbar className="d-none d-lg-flex bg-primary">
        <div className=" d-flex flex-row justify-content-between w-100 px-4 align-items-center">
          ...
          <Nav className=" gap-4">
            <Nav.Link href="#home" className="text-white">OVERTIDSMAT</Nav.Link>
            <Nav.Link href="#link" className="text-white">CATERING</Nav.Link>
            <Nav.Link href="#link" className="text-white">GRILL</Nav.Link>
            <Nav.Link href="#link" className="text-white">KONTAKT OSS</Nav.Link>
          </Nav>
          <Nav.Link href="#link" className="text-white">Last ned julemeny</Nav.Link>
        </div>
      </Navbar>
